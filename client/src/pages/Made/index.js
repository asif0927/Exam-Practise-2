  ...
  return (
   ...
   <div className={Style.made}>
        ...
        <span >BRAND NEW APP TO BLOW YOUR MIND</span>
          ...
          <p  className={Style.end}>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed doeiusmo d tempor incididunt ut labore et dolore magna aliqua.Get Started Now</p>
